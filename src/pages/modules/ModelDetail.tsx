      ...
      {isClassicTool && <>
        ...
        <div className="px-5">
          ...
          <div className="flex gap-2 mt-3">
            {([
              { id: 'nb' as const, name: 'Nano Banana', desc: 'Качественный · реалистичный', price: '$0.20', color: '#ffd96b' },
              { id: 'wan' as const, name: 'WAN 2.7', desc: 'Интим-контент · работает хорошо', price: '$0.125', color: '#6bffd9' },
            ]).map(o => {
